...
<script>
    ...
    function createAssessment() {
		...
		//let url = 'https://psycho-assess-tlp1.vercel.app/create-assessment';
        
        let url = '/psychometric/create-assessment';

        //let url = 'https://psycho-assess-tlp1-git-test-omishra717-gmailcom.vercel.app/create-assessment'; //testing url
        ...
        const quesdata = axios(url,options)
                        .then((response) => {
                            ...
                            assessmentLink = window.location.origin + '/' + 'assessment/' + assessmentID;
